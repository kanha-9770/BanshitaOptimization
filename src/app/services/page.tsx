import Pages from "@/components/services/Pages";
import React from "react";
import seoData from "@/components/Constants/services/services_data.json";
import { Metadata } from "next";

// Define ServicesSeoData interface to match your JSON structure
interface ServicesSeoData {
  title: string;
  description: string;
  keywords: string;
  openGraph: {
...
export async function generateMetadata(): Promise<Metadata> {
  const metadata: ServicesSeoData | undefined = seoData?.servicesSeoData;
