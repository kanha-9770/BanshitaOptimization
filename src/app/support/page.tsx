import Pages from "@/components/support/Pages";
import React from "react";
import seoData from "@/components/Constants/support/support_data.json";
import { Metadata } from "next";

// Define SupportSeoData interface to match your JSON structure
interface SupportSeoData {
  title: string;
  description: string;
  keywords: string;
  openGraph: {
...
export async function generateMetadata(): Promise<Metadata> {
  const metadata: SupportSeoData | undefined =
    seoData.Support[0]?.supportSeoData;
