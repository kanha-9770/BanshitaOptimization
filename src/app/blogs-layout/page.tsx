...
import seoData from "@/components/Constants/blogs/blogsLayout_data.json";
import { Metadata } from "next";

// Define BlogsLayoutSeoData interface to match your JSON structure
interface BlogsLayoutSeoData {
  title: string;
  description: string;
  keywords: string;
  openGraph: {
...
export async function generateMetadata(): Promise<Metadata> {
  const metadata: BlogsLayoutSeoData | undefined =
    seoData?.blogsLayoutSeoData;
