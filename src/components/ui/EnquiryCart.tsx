...
export default function EnquiryCart({ items, onRemoveItem, maxItems = 10 }: EnquiryCartProps) {
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col">
            <div className="bg-white border-b p-2 flex justify-between items-center">
              <div className="flex items-center gap-2">
                <h3 className="font-medium text-sm text-gray-700">Enquiry Cart</h3>
            ...
            <div className="p-2 overflow-x-auto">
              <div className="flex gap-2">
                {items.length === 0 ? (
                  <p className="text-gray-500 text-center w-full py-2 text-sm">Your enquiry cart is empty</p>
                ) : (
                  items.map((item) => (
                    <div
                      key={item.id}
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="sm:max-w-[900px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Fill out the form to contact the supplier about the items in your cart.
            </DialogDescription>
          </DialogHeader>
