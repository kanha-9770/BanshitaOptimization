...
import Bulb from "../../../public/assets/knowledgeCenter/Bulb.svg";
    ...
    <div className="flex pt-24 bg-black h-screen w-full flex-col font-regular font-poppins">
      <div className="h-[10%]">
        <p className="text-5xl px-10 font-poppins font-semibold  text-white">
          {data.knowledgeCenter[0]?.Hero.title}
        </p>
      </div>
        ...
        <div className="w-1/2 pr-4">
          ...
          <div className="text-white py-20 w-[95%]">
            <p className="text-left text-3xl font-medium mb-10">
              {data.knowledgeCenter[0]?.Hero.subtitle
                .split(" ")
                .slice(0, -1)
                .join(" ")}{" "}
              <span className="text-[#8c52ff]">
                {data.knowledgeCenter[0]?.Hero.subtitle.split(" ").slice(-1)}
              </span>
            </p>
            <div className="flex justify-center gap-10">
              {data.knowledgeCenter[0]?.Hero.section.map((item, idx) => (
