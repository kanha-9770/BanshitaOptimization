...
import { Header } from "@/components/Constants/vision/vision_data.json";
    ...
    <>
      <div className="mb-14 lg:mt-0 mt-14 w-full font-poppins font-regular overflow-hidden">
        <div className="w-full lg:h-screen h-[34rem] relative flex items-center justify-center">
          ...
          <button className="bg-white w-[8rem] h-[2rem] rounded-[1rem] pr-1 flex items-center absolute bottom-40 lg:hidden" aria-label="Right" >
